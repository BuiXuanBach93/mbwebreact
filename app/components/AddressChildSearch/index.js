...
render() {
    if(!this.addresses){
        ...
        const addressesElement = this.props.addresses.map((item, i) => {
            return <Li key={item.addressId}>
                <ChooseDiv  onClick={()=> {this.props.handleClickChildAddress(item.addressId, item.areaName);}}>
                        <ChosenLabelDiv>
...
export default AddressChildSearch;